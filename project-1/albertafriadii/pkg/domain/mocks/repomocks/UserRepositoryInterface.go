...
func (_m *UserRepositoryInterface) DeleteUser(ctx context.Context, user_id string) error {
...
func (_m *UserRepositoryInterface) UpdateUser(ctx context.Context, u domain.Users, user_id string) (domain.Users, error) {
