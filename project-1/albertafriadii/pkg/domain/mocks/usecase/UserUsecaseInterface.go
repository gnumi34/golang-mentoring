...
func (_m *UserUsecaseInterface) LoginUser(ctx context.Context, u domain.Users) (string, error) {
	ret := _m.Called(ctx, u)

	var r0 string
	if rf, ok := ret.Get(0).(func(context.Context, domain.Users) string); ok {
		r0 = rf(ctx, u)
	} else {
		r0 = ret.Get(0).(string)
	}
...
func (_m *UserUsecaseInterface) UpdateUser(ctx context.Context, u domain.Users, UserID string) (domain.Users, error) {
