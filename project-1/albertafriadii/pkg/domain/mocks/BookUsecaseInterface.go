...
// BorrowedBook provides a mock function with given fields: ctx, bb
func (_m *BookUsecaseInterface) BorrowedBook(ctx context.Context, bb domain.BorrowBook) (domain.BorrowBook, error) {
...
func (_m *BookUsecaseInterface) CreateBook(ctx context.Context, b domain.Book) (domain.Book, error) {
	ret := _m.Called(ctx, b)
...
func (_m *BookUsecaseInterface) DeleteBook(ctx context.Context, BookID string) error {
...
func (_m *BookUsecaseInterface) LendedBook(ctx context.Context, lb domain.LendBook) (domain.LendBook, error) {
...
func (_m *BookUsecaseInterface) ListBook(ctx context.Context, b domain.Book) (domain.Book, error) {
	ret := _m.Called(ctx, b)
...
func (_m *BookUsecaseInterface) ListBorrowBook(ctx context.Context, bb domain.BorrowBook) (domain.BorrowBook, error) {
	ret := _m.Called(ctx, bb)
...
func (_m *BookUsecaseInterface) ListLendBook(ctx context.Context, lb domain.LendBook) (domain.LendBook, error) {
	ret := _m.Called(ctx, lb)
...
func (_m *BookUsecaseInterface) UpdateBook(ctx context.Context, b domain.Book, BookID string) (domain.Book, error) {
...
type mockConstructorTestingTNewBookUsecaseInterface interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewBookUsecaseInterface(t mockConstructorTestingTNewBookUsecaseInterface) *BookUsecaseInterface {
